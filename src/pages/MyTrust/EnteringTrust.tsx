  ...
  return (
    <div className="m-auto gradient-bg1 flex h-[720px] max-w-[475px] flex-col flex-shrink-0 overflow-clip rounded-xl shadow-block">
      <div className="flex flex-auto flex-col px-12">
        ...
        <div className="gradient-text1 mt-12 text-center font-title text-[32px]">{t('Welcome to Aries Trust Company')}</div>
        <div className="gradient-text1 mt-4 text-center font-title text-[32px]">{t('[Settlor]')}</div>
