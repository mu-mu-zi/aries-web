...
export default function CreatingCommand({ onClose }: {
  ...
  return (
    <ModalContainer>
      <ModalNav title="Investment instructions" onClose={onClose} />
              ...
              <label>
                <div className="flex flex-col gap-2">
                  <div className="flex flex-row gap-1">
                    ...
                    <div className="text-[#99AC9B] font-bold text-[20px]">Investment Recommendation</div>
                  </div>
                  <textarea
                    ...
                    placeholder="To better handle investment instructions, please describe them as completely as possible, including the following:
