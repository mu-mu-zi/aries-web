...
export default function InvestmentDetails({ trustInvestment }: {
  ...
  const statusText = (status: number) => {
    switch (status) {
      case 1: return formatMessage({ defaultMessage: 'Initiated', description: '投资指令状态' });
      case 2: return formatMessage({ defaultMessage: 'Under review', description: '投资指令状态' });
      case 3: return formatMessage({ defaultMessage: 'Investment', description: '投资指令状态' });
      case 4: return formatMessage({ defaultMessage: 'Verifying', description: '投资指令状态' });
      case 5: return formatMessage({ defaultMessage: 'Completed', description: '投资指令状态' });
      case 6: return formatMessage({ defaultMessage: 'Verification failed', description: '投资指令状态' });
      case 7: return formatMessage({ defaultMessage: 'Canceling', description: '投资指令状态' });
      case 8: return formatMessage({ defaultMessage: 'Cancelled', description: '投资指令状态' });
      default: return '--';
    }
  };
