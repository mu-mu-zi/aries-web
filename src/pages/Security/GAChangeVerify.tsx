  ...
  return (
    <CenterContainer>
      ...
      <div className="flex-auto flex flex-col ">
        <div className="gradient-text1 my-16 text-center font-title font-bold text-[32px] text-shadow-block"><FormattedMessage defaultMessage="Change Google Authenticator" /></div>
